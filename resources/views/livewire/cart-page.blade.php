                        ...
                        <table class="w-full">
                            ...
                            <tbody>
                                ...
                                <tr wire:key="{{ $item['product_id'] }}">
                                    ...
                                    <td class="py-4">{{ Number::currency($item['unit_amount'] ?? 0,'COP') }}</td>
                                    <td class="py-4">
                                        <div class="flex items-center">
                                    ...
                                    <td class="py-4">{{ Number::currency($item['total_amount'] ?? 0,'COP') }}</td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="text-center py-4 text-4xl font-semibold text-slate-500">No items in the cart</td>
                                    </tr>
                ...
                <div class="md:w-1/4">
                    <div class="bg-white rounded-lg shadow-md p-6">
                        ...
                        <div class="flex justify-between mb-2">
                            <span>Subtotal</span>
                            <span>{{ Number::currency($grand_total ?? 0,'COP') }}</span>
                        </div>
                        <div class="flex justify-between mb-2">
                            <span>Taxes</span>
                            <span>{{ Number::currency($taxes ?? 0,'COP') }}</span>
                        </div>
                        <div class="flex justify-between mb-2">
                            <span>Shipping</span>
                            <span>{{ Number::currency($shipping ?? 0,'COP') }}</span>
                        </div>
                        <hr class="my-2">
                        <div class="flex justify-between mb-2">
                            <span class="font-semibold">Total</span>
                            <span class="font-semibold">{{ Number::currency($grand_total ?? 0,'COP') }}</span>
                        </div>
                        @if($cart_items)
